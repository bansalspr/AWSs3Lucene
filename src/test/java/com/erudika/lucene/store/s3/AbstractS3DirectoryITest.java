...
//				final String word = (String) element;
				...
				final String word2 = "delhi";
				doc.add(new StringField("keyword", word, Field.Store.NO));
				doc.add(new StringField("unindexed", word, Field.Store.NO));
				doc.add(new StringField("unstored", word2, Field.Store.NO));
				doc.add(new StringField("text", word2, Field.Store.NO));
...
//			System.out.println("\n=========QUERY=========");
			Query query = new TermQuery(new Term("keyword", "bansal"));

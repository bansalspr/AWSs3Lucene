...
public class S3DirectoryGeneralOperationsITest extends AbstractS3DirectoryITest {
	...
	public static final String TEST_BUCKET = "example5-xyz";
	public static final String TEST_BUCKET1 = "example6-xyz";
	public static final String TEST_BUCKET2 = "example7-xyz";

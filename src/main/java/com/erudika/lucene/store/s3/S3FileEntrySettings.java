 ...
 * setting, {@linkcom.erudika.lucene.store.s3.index.FetchOnBufferReadS3IndexInput} for the
...
public class S3FileEntrySettings {
	...
	public S3FileEntrySettings() {
		...
		setClassSetting(S3FileEntrySettings.INDEX_INPUT_TYPE_SETTING, FetchOnOpenS3IndexInput.class);
